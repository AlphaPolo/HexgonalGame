...
export class RedHood extends StandardCharacter {
  ...
  currentUseAnimate = () => {
    switch (this.currentState) {
      case RedHoodState.IDLE:
        return RedHood.idleFrames;
      case RedHoodState.RUNNING:
        return RedHood.runningFrames;
      case RedHoodState.SLIDE:
        return RedHood.slideFrames;
      case RedHoodState.SHOOT:
        return RedHood.shootFrames;
      case RedHoodState.LIGHT_ATTACK:
        return RedHood.lightAttackFrames;
      case RedHoodState.HEAVY_ATTACK:
        return RedHood.heavyAttackFrames;
      case RedHoodState.HURT:
        return RedHood.hurt1Frames;
      default:
        return RedHood.idleFrames;
    }
  };
  ...
  attackTo(hexOrUnit: StandardCharacter | Hex): void {
    ...
    this.animationComplete = (state) => {
      ...
      this.notifyComplete(CompleteType.ATTACKING);
    };
    this.facingTo(hex);
  }
