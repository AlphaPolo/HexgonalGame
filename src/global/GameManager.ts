...
import { Hex, OnCurrentHexChange, OnHexClick } from "../pages/Hex";
...
export class GameManager {
  ...
  public getCommandList(): CommandList | null | undefined {
    return this._commandList;
  }

  public setCommandList(value: CommandList) {
  ...
  public isBlockOn(hex: Hex): boolean {
    ...
    if (
      units
        ...
        .find(
          (unitHex) =>
            unitHex?.q === hex.q && unitHex?.r === hex.r && unitHex?.s === hex.s
        )
    )
      return true;
    return false;
